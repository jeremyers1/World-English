// need to first create JSON file from txt or excel spreadsheet and save it to json variable
// Create the excel csv file. Then go here: https://shancarter.github.io/mr-data-converter/ and convert it to JSON-dictionary
// make sure all key-value pairs are each wrapped in double quotes
...
const wordMap = new Map(Object.entries(json));
